...
Selecting one of multiple states | std_msgs/UInt16.msg | data represents a unique id of the different states (e.g. either based on the ids in CAN standard or any unique id for standardization)
